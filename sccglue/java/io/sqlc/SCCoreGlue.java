...
public class SCCoreGlue {
  ...
  /** Interface to C language function: <br> <code> int scc_bind_long(int connection_id, int index, long value); </code>    */
  ...
  /** Interface to C language function: <br> <code> long scc_get_column_long(int connection_id, int column); </code>    */
