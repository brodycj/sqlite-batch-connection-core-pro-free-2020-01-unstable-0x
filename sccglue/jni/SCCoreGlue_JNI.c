/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Wed Jun 10 21:35:05 EDT 2020 ----! */
...
/*   Java->C glue code:
 *   Java package: io.sqlc.SCCoreGlue
 *    Java method: int scc_bind_text16(int connection_id, int index, java.lang.String text, int length)
 *     C function: int scc_bind_text16(int connection_id, int index, void *  text, int length);
 */
JNIEXPORT jint JNICALL
