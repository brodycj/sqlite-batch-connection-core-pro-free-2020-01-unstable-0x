/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Sun Jun 14 14:04:06 EDT 2020 ----! */
/* EXCEPTION: MANUAL UPDATE changes with comments in: scc_bind_text_utf16_bytes */
...
Java_io_sqlc_SCCoreGlue_scc_1bind_1text_1utf16_1bytes__IILjava_lang_String_2I(JNIEnv *env, jclass _unused, jint connection_id, jint index, jstring text, jint length) {
  ...
  // MANUAL UPDATE:
  _res = scc_bind_text_utf16_bytes((int) connection_id, (int) index, (void *) _strchars_text, (int) (*env)->GetStringLength(env, text) * 2);
  if ( NULL != text ) {
    // MANUAL UPDATE:
